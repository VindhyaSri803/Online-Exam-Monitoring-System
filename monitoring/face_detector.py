...
class FaceDetector:
    ...
    def detect_faces(self, frame: np.ndarray) -> Tuple[int, list]:
        ...
        # faces is a list/ndarray of (x, y, w, h)
        boxes = []
        if len(faces) > 0:
        ...
        Returns:
            {
                ...
                "face_count": int,
                "boxes": list,
                "status": "FACE_PRESENT" | "FACE_ABSENT" | "MULTIPLE_FACES_DETECTED",
                "timestamp": float
            }
        """
    ...
    def save_annotated_frame(self, frame: np.ndarray, boxes: list, output_path: str, caption: str = "") -> bool:
        ...
        try:
            ...
            for b in boxes:
                ...
                cv2.putText(annotated, "Candidate Face", (x, max(y - 10, 15)),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
            
            if caption:
                cv2.putText(annotated, caption, (10, 30),
